...
sudo docker run -d --name startprom --net host -p https://localhost:9090:9090 -v $PWD/PrometheusGrafana/prometheus.yml:/etc/prometheus/prometheus.yml prom/prometheus:v2.2.1
